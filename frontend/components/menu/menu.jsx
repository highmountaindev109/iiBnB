    ...
    menuItems(){
        ...
        this.props.currentUser ? (
            <div className="menu-item">
                <button className="menu-button"> <a href='#/trips'> {this.props.currentUser.first_name}'s Trips</a></button>
                {/* <button className="menu-button" > Messages </button> */}
                {/* <button className="menu-button" > Reservations </button> */}
                <button className="menu-button" > <a href='#/new/listing'> Create a Listing </a></button>
