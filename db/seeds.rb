...
listing2 = Listing.create!(host_id: 1, title: "The Beach", description: "Just a beach house", address: "Somewhere in Miami", guest_limit: 12, price: 1200, bedrooms: 8, bathrooms: 6 )
listing3 = Listing.create!(host_id: 2, title: "The Cabin in the Woods", description: "It's a cabin in the woods", address: "Somewhere undisclosed", guest_limit: 6, price: 237, bedrooms: 3, bathrooms: 1.5 )
